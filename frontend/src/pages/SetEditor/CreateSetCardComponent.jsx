        ...
        <div className="flex flex-col md:flex-row justify-evenly md:justify-between px-8 py-5">
            ...
            <div className="flex justify-start md:justify-between gap-3 pb-2 md:pb-0">
                <div className="max-w-sm">
                  <button 
                    className="btn bg-[#DE2124] btn-md rounded-full border-none text-white text-[1.05rem] font-medium hover:bg-[#F83C40]"
                    onClick={onDelete}
                  >
                ...
                <div className="max-w-sm">
                  <button 
                    className="btn btn-ghost btn-md rounded-full border-black text-[1.05rem] font-medium 
                ...
                <div className="max-w-sm">
                  <button 
                    className="btn bg-[#334758] btn-md rounded-full border-none text-white font-medium text-[1.05rem] hover:bg-[#3d5469]"
                    onClick={onSave}
                  >
                    Save +
                  </button>
